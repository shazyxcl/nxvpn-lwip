...
public class NxVpn extends Application {
    private static final String TAG = NxVpn.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        // Material You — aktifkan Dynamic Color di semua Activity (Android 12+)
        // Pada Android < 12 akan fallback ke warna default di themes.xml
